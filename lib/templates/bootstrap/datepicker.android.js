...
function datepicker(locals) {
  ...
  if (locals.hasError) {
    datepickerViewStyle = stylesheet.dateTouchable.error;
  ...
  var value = locals.value
    ...
    : <Text style={[ dateValueStyle, { color: '#aaa'} ]}>{ locals.placeholder || '' }</Text>
        ...
        <View>
          ...
          <View style={[datepickerViewStyle, { flexDirection: 'row', justifyContent: 'space-between' }]}>
            ...
            <View style={{ justifyContent: 'center', opacity: .5, paddingRight: 12, marginTop: -2 }}>
              <Icon name="calendar" size={ 20 } color={ locals.hasError ? datepickerViewStyle.borderColor : "#000" } />
            </View>
          </View>
        </View>
      </TouchableNativeFeedback>
