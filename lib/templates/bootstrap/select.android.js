...
function select(locals) {
  ...
  var selectViewStyle = (stylesheet.selectView || {}).normal;
  var helpBlockStyle = stylesheet.helpBlock.normal;
  var errorBlockStyle = stylesheet.errorBlock;

  if (locals.hasError) {
    formGroupStyle = stylesheet.formGroup.error;
    selectViewStyle = (stylesheet.selectView || {}).error;
    controlLabelStyle = stylesheet.controlLabel.error;
    selectStyle = { ...selectStyle, ...stylesheet.select.error, ...stylesheet.pickerContainer.error, ...{ backgroundColor: stylesheet.pickerContainer.backgroundColor } };
